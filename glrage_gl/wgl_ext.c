...
typedef HGLRC(CODEGEN_FUNCPTR* PFN_PTRC_WGLCREATECONTEXTATTRIBSARBPROC)(HDC,
    HGLRC,
    const int*);
static HGLRC CODEGEN_FUNCPTR Switch_CreateContextAttribsARB(HDC hDC,
    HGLRC hShareContext,
...
/* Extension: ARB_create_context*/
PFN_PTRC_WGLCREATECONTEXTATTRIBSARBPROC _ptrc_wglCreateContextAttribsARB =
    Switch_CreateContextAttribsARB;
    ...
    const int* attribList)
{
        _ptrc_wglCreateContextAttribsARB =
            (PFN_PTRC_WGLCREATECONTEXTATTRIBSARBPROC)IntGetProcAddress(
